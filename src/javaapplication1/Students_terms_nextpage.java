 ...
 * @author nahinfarhan
 */
public class Students_terms_nextpage extends javax.swing.JFrame {

    /**
     * Creates new form Students_terms_nextpage
     */
    public Students_terms_nextpage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1250, 850));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Students_terms_nextpage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Students_terms_nextpage().setVisible(true);
            }
        });
    }
