...
public class course_enroll_student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        student_department_show = new javax.swing.JTextField();
        ...
        jLabel6.setText("Student Department");

        student_department_show.setBackground(new java.awt.Color(242, 242, 242));
        student_department_show.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        student_department_show.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        student_department_show.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                student_department_showActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(student_name_show, javax.swing.GroupLayout.DEFAULT_SIZE, 513, Short.MAX_VALUE)
                                        .addComponent(student_department_show)))
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                            .addGap(3, 3, 3)
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                            ...
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                            .addComponent(student_id_show, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(student_department_show, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
String batch = batch_show.getText();
    ...
    String teacherID = student_id_show.getText();
    String SemesteR = semester.getText();
    int teacheriD = Integer.parseInt(teacherID);
       try {
    
    String query = "INSERT INTO TeacherCountsAttendense (Batch, Course_No, Student_ID, Semester) VALUES (?, ?, ?, ?)";
...
//    String teacherID = student_id_show.getText();
//    int teacheriD = Integer.parseInt(teacherID);
    String query = "INSERT INTO TeacherPublishesFinalResult (Batch, Course_No, Student_ID, Semester) VALUES (?, ?, ?, ?)";
    PreparedStatement pst = conn.prepareStatement(query);
    pst.setString(1, batch);
    pst.setString(2, courseNo);
    pst.setInt(3, teacheriD);
    ...
    if (rowsAffected > 0) {
        ...
        JOptionPane.showMessageDialog(this, "Failed to enroll Student into course.", "Error", JOptionPane.ERROR_MESSAGE);
    }

    pst.close();
} catch (Exception e) {
    e.printStackTrace();
    JOptionPane.showMessageDialog(this, "Failed to enroll student into course: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
}
        try {
//    String batch = batch_show.getText();
//    String courseNo = course_id_show.getText();
//    String teacherID = student_id_show.getText();
//    int teacheriD = Integer.parseInt(teacherID);
    String query = "INSERT INTO TeacherGivesCTMark (Batch, Course_No, Student_ID, Semester) VALUES (?, ?, ?, ?)";
    PreparedStatement pst = conn.prepareStatement(query);
    pst.setString(1, batch);
    pst.setString(2, courseNo);
    pst.setInt(3, teacheriD);
...
String TID = student_id_show.getText();
try {
    ...
    String query1 = "SELECT First_Name, Last_Name, dpt_name FROM Student WHERE Student_ID = ?";
    PreparedStatement pst1 = conn.prepareStatement(query1);
    ...
    if (rs1.next()) {
        ...
        student_name_show.setText(F_name + " " + L_name);
        student_department_show.setText(dpt);
    } else {
        // Handle the case where no teacher is found with the given Teacher_ID
        // You can clear the fields or show an error message
        student_name_show.setText("Name not found");
        student_department_show.setText("Department not found");
    }
    ...
    private void student_department_showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_student_department_showActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_student_department_showActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new course_enroll_student().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField student_department_show;
