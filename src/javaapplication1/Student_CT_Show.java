...
public class Student_CT_Show extends javax.swing.JFrame {
...
Connection con = getConnection(); // Assuming you have a method to get a database connection
        Statement ps = null;
        ResultSet rs = null;
        String c = "SELECT * FROM `TeacherGivesCTMark` WHERE Student_ID = '" + username + "'" + " AND Semester = '" + selectedSemester + "'";
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
    ...
    private void initComponents() {
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 990, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Student_CT_Show.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Student_CT_Show().setVisible(true);
